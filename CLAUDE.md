...
- `docs/version-history.md` — Version history template (empty table).
- `docs/future-improvements.md` — Ideas backlog template (checkbox list).
- `docs/testing-checklist.md` — Example QA testing checklist (from an embedded BLE device project).

## How This Repo Is Used

Users copy `CLAUDE_TEMPLATE.md` into their own project as `CLAUDE.md` and fill in the bracketed placeholders with project-specific details. The `docs/` templates can be copied alongside it for supplementary documentation.
